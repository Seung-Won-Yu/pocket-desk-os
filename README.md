...
| 파일 탐색기 | 새 문서·복사/붙여넣기·보기·정렬·속성·파일 연결 |
| 휴지통 | 삭제 항목 복원, 영구 삭제와 비우기 |
| Microsoft Edge | 창 안 웹 보기, 사과게임 빠른 실행, 읽기 보기, 검색과 방문 기록 |
...
- 시작 메뉴 검색, 실행 창과 앱 별칭
- 바탕화면 단일 클릭 선택, 더블클릭 실행, 아이콘 이동·정렬·그리드 맞춤
- 바탕화면 파일 인라인 이름 변경, 복사/붙여넣기, 삭제, 우클릭 메뉴와 속성
