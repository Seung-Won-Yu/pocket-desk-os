...
export const NIGHT_LIGHT_KEY = "pocket-desk-night-light-v1";
export const NIGHT_LIGHT_STRENGTH_KEY = "pocket-desk-night-light-strength-v1";
...
export const QUICK_ACCESS_KEY = "pocket-desk-quick-access-v1";
export const DESKTOP_NAMES_KEY = "pocket-desk-desktop-names-v1";
...
export const NOTIFICATIONS_READ_KEY = "pocket-desk-notifications-read-v1";
...
export const FILE_EXTENSIONS_KEY = "pocket-desk-file-extensions-v1";
export const HIDDEN_ITEMS_KEY = "pocket-desk-hidden-items-v1";
...
export const runCommandAliases: Partial<Record<AppId, string[]>> = {
  ...
  snip: ["snip", "snippingtool", "snippingtool.exe", "캡처 도구", "스크린샷"],
